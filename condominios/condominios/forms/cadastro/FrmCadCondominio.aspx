<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FrmCadCondominio.aspx.cs" Inherits="condominios.forms.cadastro.FrmCadCondominio" %>
            ...
            <ul>
                <li>
                   <asp:Label Text="Id Condominio" ID="lbCondominio" runat="server" />
                    <asp:TextBox ID="txId" Text="" runat="server" />
                </li>
